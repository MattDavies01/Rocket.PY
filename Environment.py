...
class Enviroment:
    '''Keeps all evnironment infromation stored, such as 
       wind and temp conditions, as well as gravity and rail 
       length.
    ...
    def setLocation(self, latitude, longitide):
    ...
    def SetElevation(self, elevation="Open-Elevation"):
        """Set elevation of launch site given user input or using
        ...
        #elif elevation == "SRTM" self self.lat !=None and self.lon !=None:
        ...
        #     self.elevation = elev
            ...
            raise ValueError(
                ...
                "Open-Elevation API. See Enviroment.setLocation."
            )
    ...
    def setTopographicProfile(
        ...
        if type=='NASADEM_HGT':
            if dictionary== 'netCDF4':
                ...
                self.elevLonArray = rootgrp.variables["lat"][:].tolist()
                self.elevArray = rootgrp.variables['NASADEM_HGT'][:].tolist()
                #crsArray = rootgrp.variables['crs'][:].tolist().
                self.setTopographicProfileAticvated = True

                print("Regopm covered bt the Topographical file: ")
                print("Latitude from {:.6f}° to {:.6f}°".fromat(
        ...
        ValueError
            [description]
        """
        if self.setTopographicProfileAticvated == False:
             print(
